...
LogMessage::LogMessage(RawMessage m) {
  apps = 100 * bytesToInt(m.data[0], m.data[1]) / 1023.;
  bse = 100 * bytesToInt(m.data[2], m.data[3]) / 1023.;
  throttle = 100 * bytesToInt(m.data[4], m.data[5]) / 1023.;
}
